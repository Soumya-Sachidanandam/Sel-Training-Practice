...
# ## Font formatting
worksheet['A1'].font = Font(name='Blackadder ITC', bold=True, italic=True, color='D3F527')   ## formats individual cell
worksheet['B1'].font = Font(name='Forte', bold=True, italic=True, color='6CF527')   ## formats individual cell

bold_font = Font(bold=True, color='FFFFFF')
fill = PatternFill(start_color='0000FF', end_color='F54927', fill_type='solid')
...
data_list = [
    ...
    ['Paresh', 'Gujarat', 75000, 'paresh@gmail.com']
]

for row in data_list:
    worksheet.append(row)

excel_workbook.save(r'C:\Users\Naveen\PycharmProjects\Selenium_Training\training\Files\candidates_data.xlsx')
